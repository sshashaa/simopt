function [minmax, d, m, VarNature, VarBds, FnGradAvail, ...
          ...
          OptimalSol, NumRngs, isRandom] = SANRNDStructure(NumStartingSol, ProblemInstance)

% Inputs:
%   a) NumStartingSol: Number of starting solutions, required. Integer, >= 0
%        or -1 if calling to obtain isRandom
%   b) ProblemInstance: a cell containing the problem
...
isRandom = 1; % problem is randomly generated

% Check if ProblemInstance is provided
if isempty(ProblemInstance)
    numnodes = 0;
    numarcs = 0;
    arc = 0;
else
